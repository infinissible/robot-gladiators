var fight = function(enemy) {  
  ...
  if (promptFight === "skip" || promptFight === "SKIP") {
    ...
    // remove player's health by substracting the amount set in the enemy.attack variable
    ...
    if (playerInfo.health <= 0) {
        ...
        // leave while () loop if plyaer is dead
        break;
    } else {
...
var endGame = function () {
  ...
  // ask plyaer if they'd like to play again
